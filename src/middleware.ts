...
const PUBLIC_EXACT = new Set(["/", "/services", "/demo", "/on-vous-montre", "/pilotage-financier-pme", "/cgv", "/mentions-legales", "/confidentialite", "/set-password", "/robots.txt", "/sitemap.xml"]);
